...
public class PasswordMatchExceptionCode extends ExceptionBase {

    public PasswordMatchExceptionCode(ErrorResponseCode errorResponseCode, @Nullable String message) {
